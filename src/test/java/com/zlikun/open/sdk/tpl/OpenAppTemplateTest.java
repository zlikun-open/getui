...
/**
 * 点击通知打开应用模板
 * http://docs.getui.com/server/java/template/
 * @author zlikun <zlikun-dev@hotmail.com>
 * @date 2017-11-22 15:58
 */
@Slf4j
public class OpenAppTemplateTest {
     ...
     * @throws Exception
     */
    private AbstractTemplate createTemplate(String appId ,String appKey ,String title ,String content ,String transmissionContent ,String logoUrl) throws Exception {
        // 通知模板
